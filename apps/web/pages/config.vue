    ...
    <div class="mx-auto relative z-10 px-4 py-8 space-y-6 transition-all duration-500" :class="isDesktopLayout ? 'max-w-4xl' : 'max-w-md'">
      ...
      <header class="flex items-center justify-between bg-white dark:bg-slate-900 border border-gray-200 dark:border-slate-800 px-3 py-2 rounded-md shadow-sm transition-colors duration-300">
        <div class="flex items-center gap-3">
          ...
          <h1 class="text-base font-bold uppercase tracking-wider text-gray-900 dark:text-gray-100 border-l border-gray-100 dark:border-slate-700 pl-3">System Config</h1>
        </div>
        <div class="flex items-center gap-3">
      ...
      <div class="space-y-6">
        ...
        <section class="space-y-4 border-b border-gray-200 dark:border-slate-800 pb-6">
          ...
          <div class="space-y-1">
            <h2 class="text-xs font-medium text-gray-900 dark:text-gray-100">Lifecycle Settings</h2>
            <p class="text-[11px] text-gray-500 dark:text-gray-400 mt-1 mb-4">
          ...
          <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <div class="space-y-2">
              ...
              <input 
                ...
                type="date" 
                class="w-full bg-gray-50 dark:bg-slate-800 border border-gray-200 dark:border-slate-700 rounded-md px-3 py-2 text-[11px] focus:outline-none focus:ring-1 focus:ring-emerald-500 transition-all"
              />
            </div>
        ...
        <section class="space-y-4">
          <div class="space-y-1 px-1">
            <h2 class="text-xs font-medium text-gray-900 dark:text-gray-100">Sensor Thresholds</h2>
